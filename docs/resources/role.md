...
- `permissions` (Set of String) The role permissions. Permissions should start with "bb." prefix. Check https://github.com/bytebase/bytebase/blob/release/3.17.0/backend/component/iam/permission.yaml for all permissions.
