...
- `condition` (String) The database group condition. Check the proto message https://github.com/bytebase/bytebase/blob/release/3.17.0/proto/v1/v1/database_group_service.proto#L186 for details.
