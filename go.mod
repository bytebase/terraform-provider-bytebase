...
require (
	buf.build/gen/go/bytebase/bytebase/connectrpc/go v1.19.1-20260114032510-ea6fbab7b3fa.2
	buf.build/gen/go/bytebase/bytebase/protocolbuffers/go v1.36.11-20260114032510-ea6fbab7b3fa.1
